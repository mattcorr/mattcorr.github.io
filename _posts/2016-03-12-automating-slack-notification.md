...
header:
    image: "https://mcblogfiles.blob.core.windows.net/images/2016/03/header01.jpg"
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-11_09-11-14.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-11_09-57-24-1.png)

Select **Build your Own** from the top right.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-11_10-12-41.png)

We will be creating an integration for just our team. Click on **Make a Custom Integration**.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-11_10-12-53.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-11_10-13-05.png)

Select a default Channel. (this can be changed later) and click on **Add Incoming WebHooks Integration**.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-11_10-13-19.png)

Make sure you take a copy of the URL for the webhook as that is needed later.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-11_10-13-40.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-11_12-19-20.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-11_12-38-26.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_10-43-34.png)

Create a new Automation account.  Give it a name and select a location that is nearby and click on **Create**.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_10-44-06.png)

The Automation account panel will appear. Click on the **Runbooks** button. Then click on **Add a runbook**.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_10-44-56.png)

Click on **Create a new runbook**. Enter a name, set the runbook type to **PowerShell** and click **Create**.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_10-45-54.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_10-55-26.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_10-57-09.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-00-40.png)

Click **Add a variable**. Set the **Name** and **Value**. You can optionally set the Description too. Click on **Create**.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-03-47.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-05-50.png)

If you try to edit the password, you will get a masked string to edit.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-06-30.png)

After setting up all the variables, your **Asset->Variables** panel should look something like this:

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-06-06.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-40-34.png)

This will insert in code for getting the value from the Automation Asset.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-40-45.png)

Repeat this for the other five variables. You should end up with something like this:

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-41-11.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-46-11.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-51-30.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-53-20.png)

This will create the schedule. To confirm the linking of it to the runbook. Click on **OK**.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-54-38.png)

Back at the runbook panel screen the Schedule counter should increment to 1.

![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_11-54-52.png)
...
![](https://mcblogfiles.blob.core.windows.net/images/2016/03/2016-03-12_12-00-09.png)
